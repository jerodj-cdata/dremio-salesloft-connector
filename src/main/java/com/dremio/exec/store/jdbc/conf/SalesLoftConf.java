...
@SourceType(value = "SalesLoftARP", label = "SalesLoft",uiConfig = "salesloft-layout.json")
public class SalesLoftConf extends AbstractArpConf<SalesLoftConf> {
  private static final String ARP_FILENAME = "arp/implementation/salesloft-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.salesloft.SalesLoftDriver";
